...
export default function Hero( ) {
    ...
    return (
        ...
        <div className="border-2 border-primary/5 font-serif shadow-xl rounded-full px-7 flex flex-col items-start mt-30 py-17 sm:mr- bg-white/10  md:bg-white/500 backdrop-blur-sm text-center sm:px-15s md:text-left md:px-20 md:py-12 md:mt-0 z-30 animate-in slide-in-from-bottom duration-700">
            <h1 className="text-shadow-lg text-2xl ml-9 md:text-5xl md:ml-12 flex w-70 sm:w-130 sm:text-5xl text-center sm:ml-0 font-bold md:w-140 text-primary">
